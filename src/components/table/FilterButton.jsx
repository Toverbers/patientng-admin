...
const FilterButton = ({ sortDirection,onClick }) => (
...
<div onClick={onClick} className="cursor-pointer flex text-nowrap text-[#252525] text-[14px] font-medium space-x-2 border rounded-md px-3 py-2 items-center">
      <p>Sort by: {sortDirection === 'asc' ? 'Ascending' : 'Descending'}</p>
      <svg
        width="16"
        height="16"
        viewBox="0 0 16 16"

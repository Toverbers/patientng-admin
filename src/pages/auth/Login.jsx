...
const Login = () => {
  ...
  const {login, loading, authenticated} = useAuthStore()
    ...
    <AuthLayout
      ...
      content={
        ...
        <form className="space-y-4">
          ...
          <CustomButton className='w-full h-[40px] bg-emerald-500 hover:bg-emerald-800' onClick={handleSubmit} disabled={loading}>

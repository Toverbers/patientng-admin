...
export const useNewsletterStore = create((set,get) => ({
    ...
    getAllNewsletter: async (page = 1, limit = 10) => {
		set({ loading: true });
		...
		try {
			...
			set({  loading: false,  newsletterData: res.data.data, totalPages: res.data.pagination?.totalPages, currentPage: page, itemsPerPage: limit});
